...
export function RewardForm({
  ...
  const { register, handleSubmit, reset, setValue, watch } = useForm<Reward>({
  ...
  const onSubmit = async (data: Reward) => {
    const toastId = toast.loading(
      reward ? "Updating reward..." : "Creating reward..."
    );
        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {reward
              ...
              : "Create a new reward for redemption"}
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1 space-y-2">
              ...
              />
              <p className="text-sm text-muted-foreground">
                Set to 0 for unlimited availability
              </p>
            </div>
          </div>
