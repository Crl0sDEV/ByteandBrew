  ...
  return (
    <Layout>
      <motion.div
        ...
        className="max-w-6xl mx-auto py-8 px-4 sm:px-4 lg:px-4" // Reduced padding
      >
        {/* Main Content */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6"> {/* Reduced gap */}
          ...
          <div className="space-y-4"> {/* Reduced space between items */}
            ...
            <motion.div
              ...
              className="bg-white/90 backdrop-blur-sm p-4 rounded-xl shadow-md flex items-start gap-3 hover:shadow-lg transition-shadow" // Reduced padding
            >
              <div className="bg-primary/10 p-2 rounded-full"> {/* Smaller icon container */}
                <MapPin className="w-5 h-5 text-primary" /> {/* Smaller icon */}
              </div>
              <div>
                <h3 className="text-lg font-semibold mb-1">Our Location</h3> {/* Smaller text */}
                <address className="text-muted-foreground not-italic text-sm"> {/* Smaller text */}
            ...
            <motion.div
              ...
              className="bg-white/90 backdrop-blur-sm p-4 rounded-xl shadow-md flex items-start gap-3 hover:shadow-lg transition-shadow"
            >
            ...
            <motion.div
              ...
              className="bg-white/90 backdrop-blur-sm p-4 rounded-xl shadow-md flex flex-col items-center hover:shadow-lg transition-shadow"
            >
              <h3 className="text-lg font-semibold mb-3">Follow Us</h3> {/* Reduced margin */}
              <div className="flex justify-center space-x-4"> {/* Reduced space between icons */}
                <motion.a 
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.9 }}
                  href="#" 
                  className="bg-primary/10 p-2 rounded-full hover:bg-primary/20 transition-colors" // Smaller padding
                >
          ...
          <motion.div
            ...
            className="bg-white/90 backdrop-blur-sm p-1 rounded-xl shadow-lg h-full min-h-[400px] hover:shadow-xl transition-shadow" // Reduced min-height
          >
            <iframe
